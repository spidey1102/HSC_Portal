...
import { isPrimaryShortcut } from './utils/platformShortcuts';
...
export default function NewPortal({ onPortalLayoutChange }) {
   ...
   */
  const updateMySubjects = useCallback((nextSubjects) => {
    const saved = saveMySubjects(nextSubjects);
    setMySubjects(saved);
  }, []);
  ...
  // The native primary shortcut opens the command line: Command + K on macOS,
      ...
      <div className="portal-body">
        {loading ? (
          ...
          <CalendarView
            ...
            onSubjectsChange={updateMySubjects}
